...
2. Process Address Space
    ...
    - 메모리 상의 프로세스  
        <figure>
        <img src="https://raw.githubusercontent.com/DvParty/Knowledge/master/ProcessThread20180519/imgs/process_address_space.png" width="400"/>
        <figcaption><i>[그림 1] Process 메모리 구조</i></figcaption>
        </figure>
    - 동적으로 변하는 영역  
